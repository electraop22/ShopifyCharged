...
async def sh(card_input: str, proxy_manager):
    ...
    async with aiohttp.ClientSession(connector=connector) as r:
        ...
        headers = {
            ...
            'referer': 'https://violettefieldthreads.com/products/accessory-sewing-patterns/products/magnolia-doll',
        ...
        data = {
            ...
            'id': '258144698384',
            'quantity': '1',
            'product-id': '1764589736772',
            'section-id': 'template--1764589736772__main',
        }
        ...
        try:
            async with r.get('https://violettefieldthreads.com/cart.js', headers=headers, timeout=30) as response:
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/258144698384',
                                        'variantId': 'gid://shopify/ProductVariant/258144698384',
                                        'properties': [],
                                        'sellingPlanId': None,
